    ...
    <div>
      <Form className="formDiv">
        ...
        <Form.Group controlId="formBasicCheckbox">
          <Form.Label style={{ margin: "auto", textDecoration: "underline" }}>
            Animations
          </Form.Label>
          <Form.Check
            type="checkbox"
      ...
      {}
      <div
        className={loading !== true ? "textContainer" : "loadingTextContainer"}
        style={{
        ...
        <div
          ...
          {loading ? <span>{exampleText}</span> : <p>{exampleText}</p>}
        </div>
      </div>
      ...
      <div className="cssCodeContainer">
        <h2 style={{ textAlign: "center" }}>
          This will display all CSS code for the options selected. Coming Soon
        </h2>
        {/* <p>
                    {".className" + " \{"}
                    < br />
